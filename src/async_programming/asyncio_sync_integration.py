...
async def performance_comparison():
    ...
    print("2. 使用asyncio.to_thread()可以将同步函数放在单独线程中运行，避免阻塞事件循环")
...
async def advanced_integration_techniques():
    ...
    # 创建自定义线程池
    custom_executor = concurrent.futures.ThreadPoolExecutor(max_workers=4, thread_name_prefix="CustomPool")
